<div id="header">
    <a href="{$base_dir}"><img src="images/header.png" border="0" width="860" height="137" alt="Safety Maps: Make and share maps of safe places to meet in the event of an emergency"></a>
    <div id="nav">
        <ul>
