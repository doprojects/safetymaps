<div id="footer">
    <p><a href="http://doprojects.org"><img src="images/mail-do-logo.png" alt="Do Projects" width="42" height="21" border="0"></a> &copy; 2011 <a href="http://doprojects.org">Do projects</a>.</p>
